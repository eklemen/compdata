...
exports.default = CompData;

var _immutabilityHelper = __webpack_require__(23);
...
function CompData() {
    ...
    var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { type: null, payload: null };
        ...
        case 'SET_COMP_DATA':
            {
                if (!state[payload.name]) {
                    return (0, _immutabilityHelper2.default)(state, _defineProperty({}, payload.name, { $set: payload.data }));
                }
                return (0, _immutabilityHelper2.default)(state, _defineProperty({}, payload.name, { $merge: payload.data }));
            }
        default:
            return state;
    }
...
var connect = exports.connect = function connect(stateProps) {
    var actions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return function (klass, stateName) {
        ...
        var _setData = function _setData(name, data) {
        ...
        if (typeof actions === 'function') {
            actionMapper = function actionMapper(dispatch) {
                return _extends({}, actions(dispatch), {
                    setData: function setData(name, data) {
                        return function (dispatch) {
                            return _setData(dispatch)(name, data);
                        };
                    }
                });
            };
        } else {
            actionMapper = _extends({}, actions, {
                setData: _setData
            });
        }

        return (0, _reactRedux.connect)(mapStateToProps, actionMapper)(klass);
    };
};
...
var _CompDataReducer = __webpack_require__(19);

var _CompDataReducer2 = _interopRequireDefault(_CompDataReducer);

var _DataComponent = __webpack_require__(20);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = {
    connect: _DataComponent.connect,
    CompDataReducer: _CompDataReducer2.default
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(38);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(17), __webpack_require__(52)(module)))
